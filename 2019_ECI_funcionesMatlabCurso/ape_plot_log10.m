function ape_plot_log10(varargin);
...
%  subplot(2,n,i);plot(plo,minPe,'k--',plo,Pe,'k',plo,refPe,'k-.',[-2.29,-2.29],[0,1],'k:');grid;
  subplot(2,n,i);plot((1/log(10))*plo,minPe,'k--',(1/log(10))*plo,Pe,'k',(1/log(10))*plo,refPe,'k:');grid;
  title(name);
  eer = max(eer,max(Pe));
end;
...
for i=1:n;
   subplot(2,n,i);
   xlabel('logit (BASE 10) prior');
   axis([min(plo/log(10)),max(plo/log(10)),0,eer*1.1]);
end;   
