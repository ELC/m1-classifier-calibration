...
% [a,b,alpha,beta] = TRAIN_S_CAL(tar_scores,nontar_scores)
% [a,b,alpha,beta] = TRAIN_S_CAL(tar_scores,nontar_scores,lambda)
%
...
for i=1:length(lambda)
  % Modified by Daniel Ramos for compatibility with newer Matlab versions.
  params = fminsearch('s_cal_obj',[0,0,5,-5],[],tar_scores,nontar_scores,lambda(i));
end;
